      ...
      <section className="portfolio-section mb-5">
        <div className="container position-relative">
          ...
          <div className="row mt-5">
            ...
            <div className="col-lg-2 p-0 col-md-4 col-sm-4 col-6 pe-1">
              <img src="./src/assets/images/portfolio-3.png" className="img-fluid" alt="portfolio" />
            </div>

            <div className="col-lg-2 p-0 col-md-4 col-sm-4 col-6 mt-md-2 pe-1">
              <img src="./src/assets/images/portfolio-4.png" className="img-fluid" alt="portfolio" />
            </div>

            <div className="col-lg-2 p-0 col-md-4 col-sm-4 col-6 mt-md-2 pe-1">
              <img src="./src/assets/images/portfolio-5.png" className="img-fluid" alt="portfolio" />
            </div>

            <div className="col-lg-2 p-0 col-md-4 col-sm-4 col-6 mt-md-2 pe-1">
              <img src="./src/assets/images/portfolio-6.png" className="img-fluid" alt="portfolio" />
            </div>
